...
class PHPExcel_Writer_OpenDocument_Cell_Comment
{
    public static function write(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Cell $cell)
    {
        ...
        $objWriter->startElement('office:annotation');
            ...
            //$objWriter->writeAttribute('draw:caption-point-x', $public->getMarginLeft());
            //$objWriter->writeAttribute('draw:caption-point-y', $public->getMarginTop());
                $objWriter->writeElement('dc:creator', $comment->getAuthor());
                // TODO: Not realized in PHPExcel_Comment yet.
                //$objWriter->writeElement('dc:date', $public->getDate());
