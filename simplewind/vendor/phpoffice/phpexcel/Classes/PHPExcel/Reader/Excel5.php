...
//		$recordData = $this->_readRecordData($this->_data, $this->_pos + 4, $length);
	...
	/**
	 *	The NOTE record specifies a public associated with a particular cell. In Excel 95 (BIFF7) and earlier versions,
