...
class HTML5
{
    ...
    private function commentState()
    {
        ...
        /* U+002D HYPHEN-MINUS (-) */
        if($char === '-') {
            /* Switch to the public dash state  */
...
class HTML5TreeConstructer
{
    ...
    private function rootElementPhase($token)
    {
        ...
        /* A public token */
            ...
            attribute set to the data given in the public token. */
    ...
    private function beforeHead($token)
    {
        ...
        /* A public token */
            ...
            set to the data given in the public token. */
    ...
    private function afterBody($token)
    {
        ...
        /* A public token */
            ...
            data given in the public token. */
            $comment = $this->dom->createComment($token['data']);
